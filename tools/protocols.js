const protocols = [
    ...
    { name: "BSquared (B²)", url: "https://www.bsquared.network/" },
    ...
    { name: "Level", url: "https://www.level.money/" },
    ...
    { name: "Midas", url:"https://midas.app/" },
    ...
    { name: "Reservoir", url: " https://www.reservoir.xyz/" },
    ...
    { name: "Splashing", url: "https://www.splashing.xyz/" },
    ...
    { name: "Takara", url: "https://app.takaralend.com/" },
